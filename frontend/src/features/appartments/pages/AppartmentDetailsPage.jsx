  ...
  return (
    <div className="w-full lg:mx-4 my-6 p-4 bg-white justify-center items-center flex flex-col">
      <div className="w-full flex flex-col lg:flex-row">
        <div className="w-full mx-4 lg:h-[350px] md:w-3/4 lg:w-1/2 flex flex-col gap-4 rounded-lg shadow-md">
      ...
      <div className="w-full mx-4 my-2 p-4 bg-white rounded-lg shadow-md">
        <h1 className="text-2xl font-bold mx-4 px-4 py-2">
          Appartment Details
        </h1>
        <div className="w-full flex flex-col items-start justify-start">
          ...
          <p className="text-gray-600">
            Amenities: {appartment.amenities.join(", ")}
          </p>
          <p
